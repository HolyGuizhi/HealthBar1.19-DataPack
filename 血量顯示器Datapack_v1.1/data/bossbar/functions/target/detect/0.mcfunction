...
execute if score @s target_timesCt >= @s bossbar_looptimes if score @s bossbar_target matches 0 run bossbar set minecraft:plyr0 visible false
...
# 往前0.05格執行
execute if score @s target_timesCt < @s bossbar_looptimes unless score @s bossbar_target matches 1.. positioned ^ ^ ^0.05 run function bossbar:target/detect/0
