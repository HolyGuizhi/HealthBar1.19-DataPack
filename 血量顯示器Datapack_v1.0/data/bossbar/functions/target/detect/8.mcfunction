...
execute if score @s target_timesCt matches 161.. if score @s bossbar_target matches 0 run bossbar set minecraft:plyr8 visible false
...
# 往前0.05格執行
execute if score @s target_timesCt matches 0..160 unless score @s bossbar_target matches 1.. positioned ^ ^ ^0.05 run function bossbar:target/detect/8
